...
// 定义不同语言的示例Markdown
const sampleMarkdownEN = `# Markdown to Rich Text Example
...
const sampleMarkdownZH = `# Markdown 富文本转换示例
...
const Md2RichTextExample = () => {
  const t = useTranslations('md2richtext')
  ...
  // 当语言变化时更新示例文本
  React.useEffect(() => {
    console.log('Md2RichTextExample: locale changed to', locale);
        ...
        <div className="w-full md:w-1/2 flex flex-col gap-4">
          <div className="bg-white p-4 rounded-lg shadow-md">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-bold">{t('htmlCode')}</h2>
              <button 
            ...
            <p className="text-xs text-gray-500 mt-2">{t('htmlCodeDescription')}</p>
          </div>
          ...
          <div className="bg-white p-4 rounded-lg shadow-md flex-1">
            ...
            />
            <p className="text-xs text-gray-500 mt-2">{t('previewDescription')}</p>
          </div>
        </div>
      </div>
    </div>
